const CARD_MESSAGES = {
  1: [
    ...
    { text: "華～願你接下來的人生只會更好、更幸福，\n然後前夫不會來鬧事！\n你的福氣在後頭！（寧嬪語氣）生日快樂🎂", from: "Ellen" },
    { text: "森日快樂🍰💥\nㄙㄟˋㄙㄟˋ尼當我的人生福星🌟㊗️小華未來持續ㄉ幸福快樂\n期待一起在新店生活ㄉ歡樂時光⌚️", from: "Eri" },
    { text: "黑皮啵思得🎂🎂\n祝華華運氣爆棚、天天有好世花生🌻\n神馬都好💪🏻💪🏻", from: "Judy" },
  ...
  2: [
    ...
    { text: "生日快樂葛瑞！\n願你家和萬事興（？）\小龍包也可以平安快樂的長大！\還有韓國老公能順利挺過風波💪🏻", from: "Ellen" },
    { text: "𝑯𝒂𝒑𝒑𝒚 𝑩𝒊𝒓𝒕𝒉𝒅𝒂𝒚!\n才看不出來30歲！好誇張💥\n謝謝尼一直幫I人解圍ＴＴ\n祝闔家平安事事順利❗️\n工作上遇到的怪人退散❗️❗️", from: "Eri" },
  ...
  4: [
    ...
    { text: "桑尼生日快樂～\n祝你身體健康、天天開心，\n今年都只會吃到好吃的東西而且不需要排隊！😎🌟", from: "Ellen" },
    { text: "工作上遇到困難時，\n謝謝桑尼總是給予許多有力的幫助！\n祝所有心願都能順利達成＆健康開心，HBD🎂✨", from: "葉來葉愛你" },
    { text: "✨🍰🌞祝桑尼生日快樂🌞🍰✨\n好喜歡一起工作、玩劇本殺跟吃好吃食物ㄉ時光！\n㊗️財運旺旺＆獲得就算吃到不好吃的食物，也會自動在尼嘴巴裡變美味的魔法🪄", from: "Eri" },
  ...
  5: [
    ...
    { text: "怡安！生日快樂！\n祝你和你的家人及愛人一切安好，\n也希望我們容易遇到可怕客戶的魔咒能早日破除😇🫶🏼", from: "Ellen" },
    { text: "耶❗️怡安生日快樂\n㊗️戀愛大順利✨討厭的人都滾遠遠💨\n也祝福家人早日康復\n最重要ㄉ是要天天開心💗", from: "Eri" },
