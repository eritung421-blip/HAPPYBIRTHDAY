const CARD_MESSAGES = {
  1: [
    ...
    { text: "華～願你接下來的人生只會更好、更幸福，\n然後前夫不會來鬧事！\n你的福氣在後頭！（寧嬪語氣）生日快樂🎂", from: "宇你相遇 好幸運" },
    { text: "森日快樂🍰💥\nㄙㄟˋㄙㄟˋ尼當我的人生福星🌟㊗️小華未來持續ㄉ幸福快樂\n期待一起在新店生活ㄉ歡樂時光⌚️", from: "最董你的心" },
    { text: "黑皮啵思得🎂🎂\n祝華華運氣爆棚、天天有好世花生🌻\n神馬都好💪🏻💪🏻", from: "Judy" },
    { text: "To 華華\n新的一歲要好運滿滿、快樂加倍！最重要的戀情要順利！！也謝謝你一直以來提供的情緒價值😆＼尼是最棒的🎉/\nPS你很適合KERORO（？）", from: "Jo是愛你" },

    
  ],
  2: [
    { text: "To 吳馬麻兼里長：\n恭喜邁入30大關🎉生日大快樂！\n一直以來靠里長帶我們橫著走感覺真好🤓\n希望小燒包快快好起來，才能快快騎在馬麻頭上！\n＼祝龍包一家闔家平安/", from: "Jo是愛你" },
    { text: "歡迎加入3字頭的隊伍啦，\n表格開始要填下一個區間了ＸＤＤ\n30歲生日快樂，坐等有天媽媽不想努力了，\n小籠包發達帶你飛！", from: "資屬於你" },
    { text: "葛瑞～\n生日快樂꒰✧₍ᐢ. .ᐢ₎✧꒱", from: "Marina" },
    { text: "祝福 Grace：\n生日快樂 天天Happy～\n寶寶平安健康長大", from: "Vivian" },
    { text: "生日快樂葛瑞！\n願你家和萬事興（？）\小龍包也可以平安快樂的長大！\還有韓國老公能順利挺過風波💪🏻", from: "宇你相遇 好幸運" },
    { text: "𝑯𝒂𝒑𝒑𝒚 𝑩𝒊𝒓𝒕𝒉𝒅𝒂𝒚!\n才看不出來30歲！好誇張💥\n謝謝尼一直幫I人解圍ＴＴ\n祝闔家平安事事順利❗️\n工作上遇到的怪人退散❗️❗️", from: "最董你的心" },
    { text: "氣氛擔當吳葛瑞！\n你的E power永遠比公司的wifi訊號還強，I人覺得厲害👍🏻\n祝帶娃順順x心願成真，HBD🎂✨", from: "葉來葉愛你" },
    { text: "生日快樂🎂🎂 祝Grace永保健康天天有好康💌 馬上發大財💵💵💵", from: "Judy" },
  ...
  3: [
    ...
    { text: "TTo 艾利高\n小小兵夥伴生日快樂～\n然後新的一年還是會繼續支持你賭博的💪\n祝你盲盒扭蛋都歐氣爆棚心想事成😎\n最重要的奧客戶退散和順順順！", from: "Jo是愛你" },
    { text: "祝福愛麗高新的一年一切順心、\n喊水會結冰，想抽什麼就有什麼！\n還有早日脫手烤箱...😍\n生日快樂🎉", from: "宇你相遇 好幸運" },
    { text: "祝愛梨膏生日快樂🍐❗️\n謝謝同期同事一起奮鬥到現在ε=ヾ(;ﾟдﾟ)/\n祝尼闔家（含貓）健康快樂🏠❤️\n奇怪ㄉ工作需求也都大退散❗️", from: "最董你的心" },
    { text: "生日跨樂🎂🎂\n祝Ally工作不卡電腦不卡好運加馬🐎🐎", from: "Judy" },
    { text: "每次看到高崎駿的作品，就覺得你的眼淚應該是白流了，\n做得很好啊很努力了誒，不要給自己太多壓力！\n祝 往理想更近一步x心想事成，HBD🎂✨", from: "葉來葉愛你" },
  ...
  4: [
    ...
    { text: "桑尼生日快樂～\n祝你身體健康、天天開心，\n今年都只會吃到好吃的東西而且不需要排隊！😎🌟", from: "宇你相遇 好幸運" },
    { text: "工作上遇到困難時，\n謝謝桑尼總是給予許多有力的幫助！\n祝所有心願都能順利達成＆健康開心，HBD🎂✨", from: "葉來葉愛你" },
    { text: "✨🌞祝桑尼生日快樂🌞✨\n好喜歡一起工作、玩劇本殺跟吃好吃食物ㄉ時光！\n㊗️財運旺旺＆獲得就算吃到不好吃的食物，也會自動在尼嘴巴裡變美味的魔法🪄", from: "最董你的心" },
    { text: "生日快樂🎂🎂 祝Sunny永遠年輕天天開心💞\n馬尼多到數不完💵💵💵", from: "Judy" },
    { text: "To 桑尼\n生日快樂🎉\n新的一歲也麻煩繼續撐著我們🤓\n祝一切順順利利 🎂每天都有好心情！\n也謝謝美食達人帶我們到處吃喝玩樂yo🤘", from: "Jo是愛你" },
  ...
  5: [
    ...
    { text: "怡安！生日快樂！\n祝你和你的家人及愛人一切安好，\n也希望我們容易遇到可怕客戶的魔咒能早日破除😇🫶🏼", from: "宇你相遇 好幸運" },
    { text: "耶❗️怡安生日快樂\n㊗️戀愛大順利✨討厭的人都滾遠遠💨\n也祝福家人早日康復\n最重要ㄉ是要天天開心💗", from: "最董你的心" },
    { text: "哈囉怡安，\n雖然最近很少跟你對到案子、\nwfh也遇不到，但還是心繫著你的！\n一定要健康快樂，祝心願成真，HBD🎂✨", from: "葉來葉愛你" },
    { text: "生日快樂🎂🎂\n祝Ann心想事成！\n掌握財富密馬🤩", from: "Judy" },
